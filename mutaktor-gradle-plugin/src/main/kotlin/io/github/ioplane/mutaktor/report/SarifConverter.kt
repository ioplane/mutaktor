...
import io.github.ioplane.mutaktor.util.JsonBuilder.escapeJson
import io.github.ioplane.mutaktor.util.JsonBuilder.quote
import io.github.ioplane.mutaktor.util.SourcePathResolver
...
public object SarifConverter {
    ...
    private fun buildSarifReport(mutations: List<SurvivedMutation>, pitVersion: String): String {
        ...
        sb.appendLine("""        "informationUri": "https://github.com/ioplane/mutaktor"""")
        sb.appendLine("      }")
        sb.appendLine("    },")
